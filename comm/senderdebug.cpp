...
void SenderDebug::noteOn(int chan, int voiceId, float v1, int midinote, int pitch, int scalenote, int v2)
{
...
void SenderDebug::pitch(int chan, int voiceId, float v1, int midinote, int pitch, int scalenote)
{
