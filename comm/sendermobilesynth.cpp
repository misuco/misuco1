...
void SenderMobileSynth::cc(int chan, int voiceId, int cc, double v1)
{
...
void SenderMobileSynth::noteOn(int chan, int voiceId, double f, int midinote, int pitch, int vel)
{
...
void SenderMobileSynth::pitch(int chan, int voiceId, double f, int midinote, int pitch) {
    sy->NoteOn(voiceId, (float)f);
}
