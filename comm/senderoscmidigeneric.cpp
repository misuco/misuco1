...
SenderOscMidiGeneric::SenderOscMidiGeneric(RC1 *rc1)
{
...
void SenderOscMidiGeneric::noteOff(int chan, int voiceId)
{
    QVariantList v;
    QString path;
...
void SenderOscMidiGeneric::setDestination(QHostAddress a, int p)
{
